...
def main():
    # Define default API key (replace with your actual key for production)
    default_api_key = os.getenv("api_key")
    
    # Load API key from environment variable or use default
    ...
    # Read the Excel file
    try:
        df = pd.read_excel('unique_tennis_rackets.xlsx', engine='openpyxl')
    ...
    for index, row in df.iterrows():
        try:
            ...
            df.to_excel('unique_tennis_rackets.xlsx', index=False, engine='openpyxl')
